						...
						<b-col cols="6">
							<validation-provider #default="validationContext" vid="type_id" :name="$t('Course type')" rules="required">
								<b-form-group :label="$t('Course type')" label-for="type_id">
									<v-select v-model="formData.type_id" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="namings.types" label="name_ar" :reduce="(type) => type.id" :clearable="false" :value="formData.type_id" :state="getValidationState(validationContext)" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</b-form-group>
						...
						<b-col cols="6">
							<validation-provider #default="validationContext" vid="gender_id" :name="$t('Gender')" rules="required">
								<b-form-group :label="$t('Gender')" label-for="gender_id">
									<v-select v-model="formData.gender_id" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="namings.genders" label="name_ar" :reduce="(gender) => gender.id" :clearable="false" :value="formData.gender_id" :state="getValidationState(validationContext)" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</b-form-group>
						...
						<b-col cols="6">
							<validation-provider #default="validationContext" vid="category_id" :name="$t('Course category')" rules="required">
								<b-form-group :label="$t('Course category')" label-for="category_id">
									<v-select v-model="formData.category_id" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="namings.categories" label="name_ar" :reduce="(category) => category.id" :clearable="false" :value="formData.category_id" :state="getValidationState(validationContext)" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</b-form-group>
						...
						<b-col cols="6">
							<validation-provider #default="validationContext" vid="location_id" :name="$t('Location')" rules="required">
								<b-form-group :label="$t('Location')" label-for="location_id">
									<v-select v-model="formData.location_id" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="namings.locations" label="name_ar" :reduce="(location) => location.id" :clearable="false" :value="formData.location_id" :state="getValidationState(validationContext)" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</b-form-group>
						...
						<b-col cols="12">
							<validation-provider #default="validationContext" vid="price" :name="$t('Price')" rules="required">
								<b-form-group :label="$t('Price')" label-for="price">
									<v-select v-model="formData.price" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$packages" :reduce="(pkg) => pkg.value" :clearable="false" :value="formData.price" :state="getValidationState(validationContext)" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</b-form-group>
								...
								<b-form-group :label="$t('Photos')" label-for="photos">
									...
									<b-alert variant="secondary" show v-if="formData.images.length">
										<div class="alert-body">
											<b-img v-for="(photo, i) in formData.images" :key="i" thumbnail :src="photo" style="height: 150px; object-fit: cover; margin-inline-end: 7px" @click="removePhoto(i)" />
										</div>
									</b-alert>
								</b-form-group>
							</validation-provider>
						...
						<b-col cols="12">
							<validation-provider #default="validationContext" vid="template_id" :name="$t('Template')" rules="required">
								<b-form-group :label="$t('Template')" label-for="template_id">
									<v-select v-model="formData.template_id" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="namings.templates" label="name" :reduce="(template) => template.id" :clearable="false" :value="formData.template_id" :state="getValidationState(validationContext)" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</b-form-group>
