<template>
	<b-sidebar id="add-new-volunteer-sidebar" :visible="isAddNewVolunteerSidebarActive" bg-variant="white" sidebar-class="sidebar-lg" shadow backdrop no-header right @hidden="resetForm" @change="(val) => $emit('update:is-add-new-volunteer-sidebar-active', val)">
				...
				<b-form class="p-2" @submit.prevent="handleSubmit(onSubmit)" @reset.prevent="resetForm">
					...
					<validation-provider #default="validationContext" vid="fname_ar" :name="$t('First name')" rules="required">
						<b-form-group :label="$t('First name')" label-for="fname_ar">
							<b-form-input id="fname_ar" v-model="volunteerData.fname_ar" autofocus :state="getValidationState(validationContext)" trim />
					...
					<validation-provider #default="validationContext" vid="sname_ar" :name="$t('Second name')" rules="required">
						<b-form-group :label="$t('Second name')" label-for="sname_ar">
							<b-form-input id="sname_ar" v-model="volunteerData.sname_ar" :state="getValidationState(validationContext)" trim />
							<b-form-invalid-feedback>
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
					...
					<validation-provider #default="validationContext" vid="tname_ar" :name="$t('Third name')" rules="required">
						<b-form-group :label="$t('Third name')" label-for="tname_ar">
							<b-form-input id="tname_ar" v-model="volunteerData.tname_ar" :state="getValidationState(validationContext)" trim />
							<b-form-invalid-feedback>
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
					...
					<validation-provider #default="validationContext" vid="lname_ar" :name="$t('Last name')" rules="required">
						<b-form-group :label="$t('Last name')" label-for="lname_ar">
							<b-form-input id="lname_ar" v-model="volunteerData.lname_ar" :state="getValidationState(validationContext)" trim />
							<b-form-invalid-feedback>
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
					...
					<validation-provider #default="validationContext" vid="gender" :name="$t('Gender')" rules="required">
						<b-form-group :label="$t('Gender')" label-for="gender">
							<b-form-radio-group id="gender" class="with-invalid-feedback" v-model="volunteerData.gender" :options="$genders" :state="getValidationState(validationContext)" />
							<b-form-invalid-feedback>
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
					...
					<validation-provider #default="validationContext" name="password" rules="required">
						<b-form-group :label="$t('Password')" label-for="password">
							<b-form-input id="password" type="password" v-model="volunteerData.password" :state="getValidationState(validationContext)" trim />
							<b-form-invalid-feedback>
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
						...
						<b-input-group>
							<b-input-group-prepend>
								<validation-provider #default="validationContext" vid="mobile_key" :name="$t('Mobile key')" rules="required">
									<v-select v-model="volunteerData.mobile_key" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$mobileCodes" :reduce="(mobileCode) => mobileCode.value" :clearable="false" input-id="mobile-key" />
									<b-form-invalid-feedback>
										{{ validationContext.errors[0] }}
									</b-form-invalid-feedback>
								</validation-provider>
					...
					<validation-provider #default="validationContext" vid="country" :name="$t('Country')" rules="required">
						<b-form-group :label="$t('Country')" label-for="country" :state="getValidationState(validationContext)">
							<v-select v-model="volunteerData.country" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$countries" :reduce="(country) => country.value" :clearable="false" input-id="volunteer-country" :value="volunteerData.country" />
					...
					<validation-provider #default="validationContext" vid="city" :name="$t('City')" rules="required">
						<b-form-group :label="$t('City')" label-for="city" :state="getValidationState(validationContext)">
							<v-select v-model="volunteerData.city" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$cities[volunteerData.country]" :reduce="(city) => city.value" :clearable="false" input-id="volunteer-city" :value="volunteerData.city" />
							<b-form-invalid-feedback :state="getValidationState(validationContext)">
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
					...
					<validation-provider #default="validationContext" vid="nationality" :name="$t('Nationality')" rules="required">
						<b-form-group :label="$t('Nationality')" label-for="nationality" :state="getValidationState(validationContext)">
							<v-select v-model="volunteerData.nationality" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$countries" :reduce="(nationality) => nationality.value" :clearable="false" input-id="volunteer-nationality" :value="volunteerData.nationality" />
							<b-form-invalid-feedback :state="getValidationState(validationContext)">
								{{ validationContext.errors[0] }}
							</b-form-invalid-feedback>
						</b-form-group>
