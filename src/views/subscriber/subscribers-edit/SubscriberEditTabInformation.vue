					...
					<b-col cols="12" md="4">
						<b-form-group :label="$t('Country')" label-for="subscriber-country">
							<validation-provider #default="validationContext" vid="country" :name="$t('Country')" rules="required">
								<v-select v-model="formData.country" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$countries" :reduce="(country) => country.value" :clearable="false" input-id="subscriber-country" :value="formData.country" :state="getValidationState(validationContext)" />
								<b-form-invalid-feedback>
									{{ validationContext.errors[0] }}
								</b-form-invalid-feedback>
							</validation-provider>
					...
					<b-col cols="12" md="4">
						<b-form-group :label="$t('City')" label-for="subscriber-city">
							<validation-provider #default="validationContext" vid="city" :name="$t('City')" rules="required">
								<v-select v-model="formData.city" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$cities[formData.country]" :reduce="(city) => city.value" :clearable="false" input-id="subscriber-city" :value="formData.city" :state="getValidationState(validationContext)" />
								<b-form-invalid-feedback>
									{{ validationContext.errors[0] }}
								</b-form-invalid-feedback>
							</validation-provider>
					...
					<b-col cols="12" md="4">
						<b-form-group :label="$t('Nationality')" label-for="subscriber-nationality">
							<validation-provider #default="validationContext" vid="nationality" :name="$t('Nationality')" rules="required">
								<v-select v-model="formData.nationality" :dir="$store.state.appConfig.isRTL ? 'ltr' : 'rtl'" :options="$countries" :reduce="(nationality) => nationality.value" :clearable="false" input-id="subscriber-nationality" :value="formData.nationality" :state="getValidationState(validationContext)" />
								<b-form-invalid-feedback>
									{{ validationContext.errors[0] }}
								</b-form-invalid-feedback>
							</validation-provider>
