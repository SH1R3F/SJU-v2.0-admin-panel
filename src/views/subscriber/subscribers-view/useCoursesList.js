...
export default function useCoursesList() {
	...
	// Table Handlers
	const tableColumns = [{ key: "#" }, { key: "name", sortable: true, label: i18n.t("Course name") }, { key: "attendance", sortable: true, label: i18n.t("Passed") }, { key: "actions", label: i18n.t("Actions") }]
