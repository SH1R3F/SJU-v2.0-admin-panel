		...
		<app-timeline>
			<app-timeline-item>
				<div class="d-flex flex-sm-row flex-column flex-wrap justify-content-between mb-1 mb-sm-0">
					...
					<small class="text-muted">Date of success</small>
				</div>
				<p class="mb-0">
					<b-img :src="require('@/assets/images/icons/pdf.png')" height="auto" width="20" class="mr-1" />
					<span class="align-bottom">Certificate.pdf</span>
				</p>
			</app-timeline-item>
			...
			<app-timeline-item variant="warning">
				<div class="d-flex flex-sm-row flex-column flex-wrap justify-content-between mb-1 mb-sm-0">
					...
					<small class="text-muted">Date of enrollment</small>
				</div>
				<p>Name of course</p>
			</app-timeline-item>

			<app-timeline-item variant="info" :title="$t('Account creation')" :subtitle="$t('Subscriber joined us')" :time="subscriberData.created_at" />
		</app-timeline>
	</b-card>
</template>
