	...
	<section id="card-content-types">
		...
		<b-row>
			<b-col md="6" lg="4">
				...
				<b-card class="mb-4">
					<b-card-text> This is some text within a card body. Jelly lemon drops tiramisu chocolate cake cotton candy soufflé oat cake sweet roll. Sugar plum marzipan dragée topping cheesecake chocolate bar. Danish muffin icing donut. </b-card-text>
				</b-card>
			...
			<b-col md="6" lg="4">
				...
				<b-card :img-src="require('@/assets/images/slider/01.jpg')" img-alt="Card image" img-top>
					<b-card-text> Some quick example text to build on the card title and make up the bulk of the card's content. </b-card-text>
					<b-card-text> Cookie topping caramels jujubes gingerbread. Lollipop apple pie cupcake candy canes cookie ice cream. Wafer chocolate bar carrot cake jelly-o. </b-card-text>
				</b-card>
			</b-col>
			...
			<b-col md="6" lg="4">
				...
				<b-card :img-src="require('@/assets/images/slider/02.jpg')" img-alt="Card image" img-top no-body>
					<!-- body -->
					<b-card-body>
...
<script>
	...
	export default {
		...
		data() {
			return {
				listData: [{ text: "Cras justo odio" }, { text: "Dapibus ac facilisis in" }, { text: "Vestibulum at eros" }],
				kitchenSinkList: [{ text: "Cras justo odio" }, { text: "Vestibulum at eros" }],
			}
		},
	}
</script>
