	...
	export default {
		...
		setup(props) {
			return {
				...
				$countries,
				items: [
					{ field: i18n.t("National id"), value: props.memberData.national_id },
					{ field: i18n.t("Source"), value: props.memberData.source },
					{ field: `${i18n.t("Date")} (${i18n.t("Hijri")})`, value: props.memberData.date },
