<template>
	<validation-observer #default="{ handleSubmit }" ref="refFormObserver">
		<b-form @submit.prevent="handleSubmit(onSubmit)" @reset.prevent="resetForm">
				...
				<b-col cols="12" md="6">
					<b-form-group :label="$t('National image')" label-for="national_image">
						<validation-provider
							...
							vid="national_image"
							:name="$t('National image')"
						>
							<b-form-file
								v-model="NationalImageFile"
								id="national_image"
							...
							<b-card-text class="my-1">
								{{ $t("Current file:") }}
								<a
									v-if="memberData.national_image"
									class="font-weight-bolder"
									target="_blank"
									:href="memberData.national_image"
									>{{ $t("National image") }}</a
								>
				...
				<b-col cols="12" md="6">
					<b-form-group :label="$t('Employer letter')" label-for="employer_letter">
						<validation-provider
							#default="validationContext"
							vid="employer_letter"
							:name="$t('Employer letter')"
						>
							<b-form-file
								v-model="EmployerLetterFile"
								id="employer_letter"
								:state="getValidationState(validationContext)"
							/>
							<b-form-invalid-feedback>
							...
							<b-card-text class="my-1">
								{{ $t("Current file:") }}
								<a
									v-if="memberData.employer_letter"
									class="font-weight-bolder"
									target="_blank"
									:href="memberData.employer_letter"
									>{{ $t("Employer letter") }}</a
								>
								<a v-else>{{ $t("Unspecified") }}</a>
							</b-card-text>
			...
			<b-row>
				<b-col cols="12" md="6">
					<b-form-group :label="$t('Newspaper license')" label-for="newspaper_license">
						<validation-provider
							#default="validationContext"
							vid="newspaper_license"
							:name="$t('Newspaper license')"
						>
							<b-form-file
								v-model="NewspaperLicenseFile"
								id="newspaper_license"
								:state="getValidationState(validationContext)"
							/>
							<b-form-invalid-feedback>
								{{ validationContext.errors[0] }}
							...
							<b-card-text class="my-1">
								{{ $t("Current file:") }}
								<a
									v-if="memberData.newspaper_license"
									class="font-weight-bolder"
									target="_blank"
									:href="memberData.newspaper_license"
									>{{ $t("Newspaper license") }}</a
								>
								<a v-else>{{ $t("Unspecified") }}</a>
							</b-card-text>
						</validation-provider>
				...
				<b-row>
					...
					<b-col cols="12">
						<b-form-group
							...
							label-for="updated_personal_information"
							label-class="mb-1"
						>
							<validation-provider
								#default="validationContext"
								vid="updated_personal_information"
								:name="$t('Personal information')"
								rules="required"
							>
								<b-form-radio-group
									id="updated_personal_information"
									v-model="formData.updated_personal_information"
									:options="$updateRequestsOptions"
									:state="getValidationState(validationContext)"
								/>
								<b-form-invalid-feedback>
									{{ validationContext.errors[0] }}
					...
					<b-col cols="12">
						<b-form-group :label="$t('Profile image')" label-for="updated_profile_image" label-class="mb-1">
							<validation-provider
								#default="validationContext"
								vid="updated_profile_image"
								:name="$t('Personal information')"
								rules="required"
							>
								<b-form-radio-group
									id="updated_profile_image"
									v-model="formData.updated_profile_image"
									:options="$updateRequestsOptions"
									:state="getValidationState(validationContext)"
								/>
								<b-form-invalid-feedback>
					...
					<b-col cols="12">
						<b-form-group
							:label="$t('National image')"
							label-for="updated_national_image"
							label-class="mb-1"
						>
							<validation-provider
								#default="validationContext"
								vid="updated_national_image"
								:name="$t('Personal information')"
								rules="required"
							>
								<b-form-radio-group
									id="updated_national_image"
									v-model="formData.updated_national_image"
									:options="$updateRequestsOptions"
									:state="getValidationState(validationContext)"
								/>
								<b-form-invalid-feedback>
					...
					<b-col cols="12">
						<b-form-group
							:label="$t('Employer letter')"
							label-for="updated_employer_letter"
							label-class="mb-1"
						>
							<validation-provider
								#default="validationContext"
								vid="updated_employer_letter"
								:name="$t('Employer letter')"
								rules="required"
							>
								<b-form-radio-group
									id="updated_employer_letter"
									v-model="formData.updated_employer_letter"
									:options="$updateRequestsOptions"
									:state="getValidationState(validationContext)"
								/>
								<b-form-invalid-feedback>
					...
					<b-col cols="12">
						<b-form-group
							:label="$t('Experiences and fields')"
							label-for="updated_experiences_and_fields"
							label-class="mb-1"
						>
							<validation-provider
								#default="validationContext"
								vid="updated_experiences_and_fields"
								:name="$t('Experiences and fields')"
								rules="required"
							>
								<b-form-radio-group
									id="updated_experiences_and_fields"
									v-model="formData.updated_experiences_and_fields"
									:options="$updateRequestsOptions"
									:state="getValidationState(validationContext)"
								/>
								<b-form-invalid-feedback>
	...
	export default {
		...
		setup(props) {
			...
			const onSubmit = function () {
				...
				// Submit
				store
					.dispatch("app-member/updateMember", {
